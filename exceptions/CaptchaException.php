...
class CaptchaException extends Exception
{
    ...
    const CODE_IMAGE_FILE_PATH_IS_NOT_SET = 3001;
    const CODE_IMAGE_IMAGICK_INSTANCE_IS_EMPTY = 3002;
    const CODE_IMAGE_DRAW_INSTANCE_IS_EMPTY = 3003;
    const CODE_IMAGE_TEXT_IS_NOT_SET = 3004;
    const CODE_IMAGE_TEXT_LENGTH_IS_NOT_SET = 3005;
    const CODE_IMAGE_WIDTH_IS_NOT_SET = 3006;
    const CODE_IMAGE_HEIGHT_IS_NOT_SET = 3007;
    const CODE_IMAGE_DOT_SIZE_HAS_BAD_FORMAT = 3008;
    const CODE_IMAGE_CREATE_ERROR = 3009;
